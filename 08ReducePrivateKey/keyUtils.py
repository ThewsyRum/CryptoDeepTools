...
class TestKey(unittest.TestCase):
    ...
    def test_privateKeyToWif(self):
        ...
        self.assertEqual(w, b"5HueCGU8rMjxEXxiPuD5BDku4MkFqeZyd4dZ1jvhTVqvbTLvyTJ")
    ...
    def test_pairs1(self):
        # blockchain.info
        wallet_addr = b"1EyBEhrriJeghX4iqATQEWDq38Ae8ubBJe"
    ...
    def test_pairs2(self):
        ...
        wallet_addr = b"1MZ1nxFpvUgaPYYWaLPkLGAtKjRqcCwbGh"
    ...
    def test_pairs3(self):
        ...
        wallet_addr = b"1Q2SuNLDXDtda7DPnBTocQWtUg1v4xZMrV"
    ...
    def test_derSigToHexSig(self):
        ...
        txn = ("0100000001a97830933769fe33c6155286ffae34db44c6b8783a2d8ca52ebee6414d399ec300000000" + "8a47" +
               ...
               "41" + "04392b964e911955ed50e4e368a9476bc3f9dcc134280e15636430eb91145dab739f0d68b82cf33003379d885a0b212ac95e9cddfd2d391807934d25995468bc55" + "ffffffff02015f0000000000001976a914c8e90996c7c6080ee06284600c684ed904d14c5c88ac204e000000000000" +
               "1976a914348514b329fda7bd33c7b2336cf7cd1fc9544c0588ac00000000")
        myTxn_forSig = ("0100000001a97830933769fe33c6155286ffae34db44c6b8783a2d8ca52ebee6414d399ec300000000" + "1976a914" +
                        "167c74f7491fe552ce9e1912810a984355b8ee07" + "88ac" + "ffffffff02015f0000000000001976a914c8e90996c7c6080ee06284600c684ed904d14c5c88ac204e000000000000" +
